...
Before running this training, you'll need to create a Hyperpod cluster with an FSx for Lustre file system. Instructions can be found in [1. Cluster Setup](/docs/slurm-orchestration/getting-started/initial-cluster-setup). Please follow them if you haven't done so already.
