...
:::info
To access AWS API through the CLI you'll need to have configured the CLI. Please refer to this section under the [cluster setup instructions](/01-cluster/01-aws-cli#configuring-aws-credentials) to learn how to do that.
:::
...
To fix this simply revert the steps [mentioned here](/07-tips-and-tricks/01-multi-user#ssm-integration) and try again.
:::
