...
This guide assumes that you've [built a SageMaker HyperPod Slurm cluster](/docs/slurm-orchestration/getting-started/initial-cluster-setup) with GPU instances i.e. g5/p4d/p5 instance types. Please make sure you have the following before getting started:
...
If you completed [Cluster Setup](/docs/slurm-orchestration/getting-started/initial-cluster-setup) using a Nvidia GPU config these steps are complete.
