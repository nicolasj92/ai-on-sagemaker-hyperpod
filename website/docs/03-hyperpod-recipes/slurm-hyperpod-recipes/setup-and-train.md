...
1. You'll need to create a cluster with Amazon SageMaker HyperPod. Instructions can be found in [1. Cluster Setup](/docs/getting-started/orchestrated-by-slurm/initial-cluster-setup). Please follow them if you haven't done so already.
