...
## Prerequisites
Before running this training, you'll need to create a SageMaker HyperPod cluster with at least 1 trn1.32xlarge / trn1n.32xlarge instance group. Instructions can be found in the [Cluster Setup](/docs/getting-started/orchestrated-by-slurm/initial-cluster-setup) section. 
...
In this section, we will setup our training environment on the cluster. Begin by logging into your cluster by following the [SSH into Cluster](/docs/getting-started/orchestrated-by-slurm/ssh-into-hyperpod) section.
