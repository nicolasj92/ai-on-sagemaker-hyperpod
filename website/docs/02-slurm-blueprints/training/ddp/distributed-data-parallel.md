...
If you don't already have a Slurm cluster, please follow the instructions in [**Cluster Setup**](/docs/getting-started/orchestrated-by-slurm/initial-cluster-setup) to create one, then do the following:
