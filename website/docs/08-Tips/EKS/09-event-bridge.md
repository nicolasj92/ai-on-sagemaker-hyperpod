...
SageMaker HyperPod delivers [two types of notifications through Amazon EventBridge](https://docs.aws.amazon.com/sagemaker/latest/dg/automating-sagemaker-with-eventbridge.html#eventbridge-hyperpod-node-health):
  
  1. Cluster status change events
  1. Node health events
...
- You can customize the format of the emails by modifying the Lambda function. You can extract more information from [the event JSON data](https://docs.aws.amazon.com/sagemaker/latest/dg/automating-sagemaker-with-eventbridge.html#eventbridge-hyperpod-node-health), or even by calling SageMaker AI service APIs.
