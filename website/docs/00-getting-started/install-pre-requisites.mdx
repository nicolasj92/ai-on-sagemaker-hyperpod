...
::::expand{header="Configure AWS Credentials" defaultExpanded=false}
...
::::expand{header="Install Kubectl (for EKS only)" defaultExpanded=false}
...
::::expand{header="Install Helm (for EKS only)" defaultExpanded=false}
...
::::expand{header="Install eksctl (for EKS only)" defaultExpanded=false}
