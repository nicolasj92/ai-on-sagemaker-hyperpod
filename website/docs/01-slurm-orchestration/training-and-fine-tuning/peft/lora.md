...
## Prerequisites
Before running this training, you'll need to create a SageMaker HyperPod cluster with at least 1 trn1.32xlarge / trn1n.32xlarge instance group. Instructions can be found in the [Cluster Setup](/docs/slurm-orchestration/getting-started/initial-cluster-setup) section. 
...
Additionally, since Llama 3 is a gated model users have to register in Hugging Face and obtain an [access token](https://huggingface.co/docs/hub/en/security-tokens) before running this example. You will also need to review and accept the license agreement on the [meta-llama/Meta-llama-3-8B-Instruct](https://huggingface.co/meta-llama/Meta-Llama-3-8B-Instruct) model page.


## Setup

In this section, we will setup our training environment on the cluster. Begin by logging into your cluster by following the [SSH into Cluster](/docs/slurm-orchestration/getting-started/ssh-into-hyperpod) section.
...
In this section, you will begin training your Llama 3 model on a Trainium `trn1.32xlarge` instance.
